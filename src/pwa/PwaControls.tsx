      ...
      {!online && (
        <div className="fixed inset-x-0 top-0 z-[60] flex items-start gap-3 bg-amber-500/95 px-4 py-2.5 text-sm text-amber-950 shadow-lg">
          <p className="flex-1 font-medium leading-snug">
            Sin conexion. 2GTech3D Lead Radar necesita internet para buscar empresas reales,
            pero podes revisar oportunidades guardadas.
          </p>
        </div>
      )}
        ...
        >
          ...
          >
            ...
            <ol className="space-y-2 text-sm text-slate-300">
              <li>1. Toca el boton Compartir en Safari.</li>
              <li>2. Elegi Agregar a pantalla de inicio.</li>
